...
var callFunc = function(){
	...
	getRadius();
	var rad = vm.radius;
	var url = "https://api.openaq.org/v1/measurements?coordinates=" + vm.lat + "," + vm.lon + "&radius=" + rad + "&date_from=2019-3-24&limit=100";
...
var callFunc2 = function(){
	...
	getRadius2();
	var rad2 = vm.radius2;
	var url = "https://api.openaq.org/v1/measurements?coordinates=" + vm.lat2 + "," + vm.lon2 + "&radius=" + rad2 + "&date_from=2019-3-24&limit=100";
